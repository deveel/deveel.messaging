...
namespace Deveel.Messaging
{
	...
	public sealed class MessagePropertyConfiguration
	{
		...
		/// <summary>
		/// Creates a fluent configuration builder for this property.
		/// </summary>
		/// <returns>A fluent builder for additional configuration.</returns>
		public MessagePropertyConfigurationBuilder Configure()
		{
			return new MessagePropertyConfigurationBuilder(this);
		}
	}

	/// <summary>
	/// Provides a fluent interface for configuring message property validation rules.
	/// </summary>
	public sealed class MessagePropertyConfigurationBuilder
	{
		private readonly MessagePropertyConfiguration _configuration;

		internal MessagePropertyConfigurationBuilder(MessagePropertyConfiguration configuration)
		{
		...
		public MessagePropertyConfigurationBuilder WithMinLength(int minLength)
		{
			_configuration.MinLength = minLength;
			return this;
		}
		...
		/// <returns>The builder for method chaining.</returns>
		public MessagePropertyConfigurationBuilder WithMaxLength(int maxLength)
		{
		...
		/// <summary>
		/// Sets both minimum and maximum length for string properties.
		/// </summary>
		/// <param name="minLength">The minimum length.</param>
		/// <param name="maxLength">The maximum length.</param>
		/// <returns>The builder for method chaining.</returns>
		public MessagePropertyConfigurationBuilder WithLengthRange(int minLength, int maxLength)
		{
			_configuration.MinLength = minLength;
			_configuration.MaxLength = maxLength;
			return this;
		...
		/// <returns>The builder for method chaining.</returns>
		public MessagePropertyConfigurationBuilder WithMinValue(object minValue)
		{
		...
		/// <returns>The builder for method chaining.</returns>
		public MessagePropertyConfigurationBuilder WithMaxValue(object maxValue)
		{
		...
		/// <summary>
		/// Sets both minimum and maximum values for numeric properties.
		/// </summary>
		/// <param name="minValue">The minimum value.</param>
		/// <param name="maxValue">The maximum value.</param>
		/// <returns>The builder for method chaining.</returns>
		public MessagePropertyConfigurationBuilder WithValueRange(object minValue, object maxValue)
		{
			_configuration.MinValue = minValue;
			_configuration.MaxValue = maxValue;
			return this;
		...
		/// <returns>The builder for method chaining.</returns>
		public MessagePropertyConfigurationBuilder WithPattern(string pattern)
		{
			_configuration.Pattern = pattern;
			return this;
		}
		...
		/// <returns>The builder for method chaining.</returns>
		public MessagePropertyConfigurationBuilder WithAllowedValues(params object[] allowedValues)
		{
			_configuration.AllowedValues = allowedValues?.ToList();
			return this;
		}
		...
		/// <param name="allowedValues">The collection of allowed values.</param>
		/// <returns>The builder for method chaining.</returns>
		public MessagePropertyConfigurationBuilder WithAllowedValues(IEnumerable<object> allowedValues)
		{
			_configuration.AllowedValues = allowedValues?.ToList();
			return this;
		}
		...
		/// <returns>The builder for method chaining.</returns>
		public MessagePropertyConfigurationBuilder WithCustomValidator(Func<object?, IEnumerable<ValidationResult>> validator)
		{
			_configuration.CustomValidator = validator;
			return this;
		}

		/// <summary>
		/// Marks the property as requiring a non-empty string value.
		/// </summary>
		/// <returns>The builder for method chaining.</returns>
		public MessagePropertyConfigurationBuilder NotEmpty()
		{
			return WithMinLength(1);
		}

		/// <summary>
		/// Returns the configured property.
		/// </summary>
		/// <returns>The configured MessagePropertyConfiguration.</returns>
		public MessagePropertyConfiguration Build()
		{
			return _configuration;
		}

		/// <summary>
		/// Implicit conversion to MessagePropertyConfiguration.
		/// </summary>
		/// <param name="builder">The builder instance.</param>
		public static implicit operator MessagePropertyConfiguration(MessagePropertyConfigurationBuilder builder)
		{
